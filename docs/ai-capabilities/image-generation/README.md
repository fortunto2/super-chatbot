...
## 💾 Автоматическое сохранение в чате

**Исправлена проблема**: Сгенерированные изображения теперь автоматически сохраняются в истории чата и остаются доступными после закрытия артефакта.

📖 **Решение проблемы**: [Chat Persistence Solution](./chat-persistence-solution.md)
